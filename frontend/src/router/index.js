...
const EmailVerificationSuccess = () => import('../views/Auth/EmailVerificationSuccess.vue')
...
const routes = [
    ...
    // Auth (GuestLayout)
    {
        ...
        children: [
            ...
            { path: 'email/verification-success', name: 'email-verification-success', component: EmailVerificationSuccess, meta: { guest: true } },
        ],
    },
...
router.beforeEach(async (to) => {
    ...
    if (to.meta.guest && authStore.isAuthenticated && !to.meta.public && ['login', 'register', 'forgot-password', 'reset-password'].includes(to.name)) return { name: 'dashboard' }
    return true
})
